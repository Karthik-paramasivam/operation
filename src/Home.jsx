      ...
      <div className="container-fluid">
        ...
        <div className="container mt-5 border border-white " id="career">
          ...
          >
            ...
            <div className="col-12 col-lg-5 rounded-3 mt-4 mt-lg-4 rounded-3 shadow p-3">
            ...
            <div className="col-12 col-md-12 col-lg-5 rounded-3 mt-5 mt-lg-4 rounded-3 shadow ms-lg-4 p-3">
              ...
              <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
                ...
                <li className="ms-lg-2 d-flex align-items-start mt-1">
                  ...
                  <span>Jobs and the business aspect of airports</span>
                </li>
                <li className="ms-lg-2 d-flex align-items-start mt-1">
                  {" "}
                  <FontAwesomeIcon
                  ...
                  <span>How to use your skills in an airport setting</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div>
              <div className="p-3 shadow-sm border border-light rounded-3 ms-lg-4 ms-2 mt-0 testimonialresponsive-div">
                ...
                <p className="text-center">
                  ...
                  The teachers are so friendly and the sessions which they keep
                  are super great and innovative. I will personally recommend
                  this institute to everyone.
                </p>
              </div>
            </div>
            <div>
              <div className="p-3 shadow-sm border border-light rounded-3 ms-md-2 ms-lg-4 ms-2 mt-0 testimonialresponsive-div">
                ...
                <p className="text-center">
                  ...
                  classes, CV, internships. Their support is commendable.
                </p>
              </div>
            </div>
            <div>
              <div className="p-3 shadow-sm border border-light rounded-3 ms-lg-4 mb-1 ms-2 mt-0 testimonialresponsive-div">
                ...
                <p className="text-center">
                  ...
                  pleasure, we never forget, and I appreciate WingsWay Training
                  Institute LLC. A great teacher inspires hope, ignites the
                  imagination, and instills a love of learning. Thank you
                  WingsWay Training Institute team for all the support and
                  guidance in next level.
                </p>
              </div>
            </div>
          </Slider>
